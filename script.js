...
function initPage() {
  ...
  // UV const currentUVI = document.querySelector("#UV-index");
  const currentUVI = document.querySelector("#UV-index");

  const UVI1 = document.querySelector("#UV-index1");
  const UVI2 = document.querySelector("#UV-index2");
  const UVI3 = document.querySelector("#UV-index3");
  const UVI4 = document.querySelector("#UV-index4");
  const UVI5 = document.querySelector("#UV-index5");
  ...
  function getUserInput() {
    ...
    $.ajax({
      ...
      wind1.innerHTML = response.list[1].wind.speed;

      // console.log("temperature 2: "+response.list[2].main.temp);
